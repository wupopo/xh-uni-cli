...
import require$$3$2 from "node:fs";
...
import require$$1$4, { execSync } from "child_process";
...
function requireAnsiEscapes() {
  ...
  (function(module) {
    const ansiEscapes2 = module.exports;
...
function requireMbcs() {
  ...
  (function(module) {
    ...
    util.inherits(module.exports.sjis, mbcs2);
    ...
    util.inherits(module.exports.big5, mbcs2);
    ...
    util.inherits(module.exports.euc_jp, mbcs2);
    ...
    util.inherits(module.exports.euc_kr, mbcs2);
    ...
    util.inherits(module.exports.gb_18030, mbcs2);
  })(mbcs);
  return mbcs.exports;
}
var sbcs = { exports: {} };
...
function requireSbcs() {
  ...
  (function(module) {
    ...
    util.inherits(module.exports.ISO_8859_1, sbcs2);
    ...
    util.inherits(module.exports.ISO_8859_2, sbcs2);
    ...
    util.inherits(module.exports.ISO_8859_5, sbcs2);
    ...
    util.inherits(module.exports.ISO_8859_6, sbcs2);
    ...
    util.inherits(module.exports.ISO_8859_7, sbcs2);
    ...
    util.inherits(module.exports.ISO_8859_8, sbcs2);
    ...
    util.inherits(module.exports.ISO_8859_9, sbcs2);
    ...
    util.inherits(module.exports.windows_1251, sbcs2);
    ...
    util.inherits(module.exports.windows_1256, sbcs2);
    ...
    util.inherits(module.exports.KOI8_R, sbcs2);
  })(sbcs);
  return sbcs.exports;
}
var iso2022 = { exports: {} };
...
const editor = createPrompt((config2, done) => {
  ...
  function startEditor(rl) {
    rl.pause();
    const editCallback = AsyncResource.bind(async (error3, answer) => {
      rl.resume();
      if (error3) {
  ...
  constructor(prompts, opt = {}) {
    ...
    __publicField(this, "fetchAnswer", async (rawQuestion) => {
      ...
      const promptFn = isPromptConstructor(prompt2) ? (q, opt) => new Promise((resolve, reject) => {
        ...
        const rl = readline__default.createInterface(setupReadlineOptions(opt));
        const onForceClose = () => {
          this.close();
...
`;
    ...
    exports.shallowCopy = function(to, from2) {
      from2 = from2 || {};
    ...
    exports.shallowCopyFromList = function(to, from2, list) {
      list = list || [];
      from2 = from2 || {};
      if (to !== null && to !== void 0) {
